...
// Background colour
renderer.setClearColor( 0x59baf3, 1 ); 

// The YoungHee skin tone 
...
class Player{
    constructor(){
        ...
        const material = new THREE.MeshBasicMaterial( { color: 0x077e09 } );
